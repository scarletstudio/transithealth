...
cli = argparse.ArgumentParser(description="Transform rent burdened households data.")
cli.add_argument("--input_file", help="File path to read rent burdened households data from.")
