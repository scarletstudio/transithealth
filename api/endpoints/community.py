...
def make_blueprint(con):
    ...
    supported_metrics = {
        ...
        "total_income_2000": lambda: metric.income(year=2000, segment="all"),
        "total_income_2010": lambda: metric.income(year=2010, segment="all"),
        "total_income_2019": lambda: metric.income(year=2019, segment="all"),
